...
function updateActiveNavLink() {
    ...
    // If no section-based link is active, highlight based on current page file name
    const currentPage = window.location.pathname.split('/').pop();
    if (currentPage) {
        const activePageLink = document.querySelector(`.nav-link[href="${currentPage}"]`);
        if (activePageLink) {
...
function updateThemeIcon() {
    ...
    const iconHTML = isDarkMode ? '<i class="fas fa-sun"></i>' : '<i class="fas fa-moon"></i>';
